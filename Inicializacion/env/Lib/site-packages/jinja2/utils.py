...
class LRUCache:
    ...
    # scale.  But as long as it's only used as storage for templates.py this
    # won't do any harm.
...
def select_autoescape(
    ...
    If you want to enable it for all templates.py created from strings or
    for all templates.py with `.html` and `.xml` extensions::
    ...
    a list of all templates.py it should be disabled for.  If a template is
...
def htmlsafe_json_dumps(
    ...
    This is available in templates.py as the ``|tojson`` filter.
...
class Cycler:
    ...
    once the end is reached. Available as ``cycler`` in templates.py.
...
class Joiner:
    """A joining helper for templates.py."""
